...
?>
    ...
    <form action="actions/edit_product_action.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?= $product->getDescripcion(); ?>">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="size" id="size">
                <?php foreach ($sizes as $size): ?>
                    <option value="<?= $size->getIdSize(); ?>" <?= $size->getIdSize() == $product->getIdSize() ? 'selected' : '' ?>>
                        <?= $size->getSize(); ?>
                    </option>
                <?php endforeach; ?>
            </select>
